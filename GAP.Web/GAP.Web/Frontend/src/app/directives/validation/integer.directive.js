...
let AppIntegerValidationDirective = class AppIntegerValidationDirective extends AppValidationDirective {
    ngOnInit() {
...
AppIntegerValidationDirective = __decorate([
    Directive({ selector: "[appIntegerValidation]" })
], AppIntegerValidationDirective);
export { AppIntegerValidationDirective };
